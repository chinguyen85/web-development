<?php 
    $title = "About - Chi Nguyen";
    $md = "This is the about page of my website";
?>
<?php include 'header.php'; ?>

<h1>About Me</h1>
<?php
    echo "<h4><i>Aim to be a full-stack developer!</i></h4>";
?>
...
<noscript>
    <p>Please enable JavaScript to see the content!</p>
</noscript>

<p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Cupiditate eligendi cumque eum laudantium saepe voluptatum fugit natus suscipit? Dolor, qui eius. Dolor eos quos suscipit voluptates aspernatur. Harum, voluptas recusandae.</p>
<p>Atque, quos expedita modi omnis repellat deleniti minima impedit perspiciatis sit ipsum esse corrupti ipsa facilis asperiores totam mollitia. Distinctio, rerum accusantium!</p>
<p>Voluptas cum qui saepe aliquid quas perferendis minus temporibus! Amet magnam totam ratione blanditiis omnis dignissimos, saepe molestias necessitatibus, aliquid architecto voluptatum.</p>
